...
public class MyBatchTestFileAdapter extends AbstractBatchFeatureDataAdaptor {
    private static final Logger logger = LoggerFactory.getLogger(MyBatchTestFileAdapter.class);
