...
//    private static CloseableHttpClient httpClient;
    ...
    public static HttpAdapterResponse doPost(String url, Map<String, Object> bodyMap) {
        ...
        HttpAdapterResponse httpresponse = getResponse(httpPost);
        logger.info(" code = " + httpresponse.getCode());
        logger.info(" data = " + httpresponse.getData());
    ...
    private static HttpAdapterResponse getResponse(HttpRequestBase request) {
        ...
        try {
            ...
            HttpAdapterResponse json2 = JsonUtil.json2Object(result, HttpAdapterResponse.class);
